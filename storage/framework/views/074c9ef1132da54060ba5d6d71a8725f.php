                        ...
                        <!-- <div class="text-center mt-sm-5 mb-4 text-white-50">
                                            <div>
                                                <a href="index" class="d-inline-block auth-logo">
                                                    <img src="<?php echo e(URL::asset('/images/logo.png')); ?>" alt="" height="60">
                                                </a>
                                            </div>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    <div class="text-center mt-3 mb-4 text-white-50">
                                        <div>
                                            <a href="index" class="d-inline-block auth-logo">
                                                <img src="<?php echo e(URL::asset('/images/logo.png')); ?>" alt="" height="60">
                                            </a>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mt-4">
                                            <button class="btn btn-success w-100" type="submit">Sign In <i
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> Sistem Informasi Stock Opname.
