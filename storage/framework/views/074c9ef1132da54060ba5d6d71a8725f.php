                    ...
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <div>
                            <a href="index" class="d-inline-block auth-logo">
                                <img src="<?php echo e(URL::asset('light-logo.png')); ?>" alt="" height="20">
                            </a>
                        </div>
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                ...
                                <p class="text-muted">Sign in to continue to SIPOTEK.</p>
                            </div>
                            <div class="p-2 mt-4">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mt-4">
                                        <button class="btn btn-success w-100" type="submit">Sign In <i class="mdi mdi-login"></i></button>
                                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> Sistem Informasi Stock Opname. Crafted with <i class="mdi mdi-heart text-danger"></i> by Toni Hardianto</p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/toni/Apps/laravel/perpetual-report-system/resources/views/auth/login.blade.php ENDPATH**/ ?>