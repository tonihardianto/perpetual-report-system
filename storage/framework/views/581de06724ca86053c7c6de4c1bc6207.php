            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="/" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="<?php echo e(URL::asset('build/logos/bimoseno-dark.png')); ?>" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="<?php echo e(URL::asset('build/logos/bimoseno-dark.png')); ?>" alt="" height="17">
                        </span>
                    </a>
                ...
                <form class="app-search d-none d-md-block">
                    <div class="position-relative">
                        <input type="text" class="form-control form-control-sm" placeholder="Cari halaman..."
                    ...
                    <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                        <div data-simplebar style="max-height: 320px;">
                            ...
                            <div class="dropdown-item bg-transparent text-wrap">
                                <a href="/master-obat" class="btn btn-soft-secondary btn-sm rounded-pill">master obat <i
                                        class="mdi mdi-magnify ms-1"></i></a>
                                <a href="/transaksi-index" class="btn btn-soft-secondary btn-sm rounded-pill">transaksi
                                    <i class="mdi mdi-magnify ms-1"></i></a>
                                <a href="/laporan-perpetual"
                    ...
                    <button type="button" class="btn shadow-none" id="page-header-user-dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                ...
                                <span
                                    class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">&#64;<?php echo e(Auth::user()->username); ?></span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Welcome <b class="text-primary"><?php echo e(Auth::user()->name); ?></b>.</h6>
                        ...
                        <a class="dropdown-item bg-danger-subtle text-danger" href="javascript:void();"
...
</div><!-- /.modal --><?php /**PATH /Users/toni/Apps/laravel/perpetual-report-system/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>