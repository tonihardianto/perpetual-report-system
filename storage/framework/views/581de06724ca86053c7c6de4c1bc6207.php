            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="<?php echo e(URL::asset('dark-logo.png')); ?>" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="<?php echo e(URL::asset('dark-logo.png')); ?>" alt="" height="17">
                        </span>
                    </a>

                    <a href="index" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="<?php echo e(URL::asset('light-logo.png')); ?>" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="<?php echo e(URL::asset('light-logo.png')); ?>" alt="" height="17">
                        </span>
                    </a>
                </div>
                ...
                <form class="app-search d-none d-md-block">
                    <div class="position-relative">
                        <input type="text" class="form-control form-control-sm" placeholder="Cari halaman..." autocomplete="off" id="search-options" value="">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                        <div data-simplebar style="max-height: 320px;">
                            ...
                            <div class="dropdown-header">
                                <h6 class="text-overflow text-muted mb-0 text-uppercase">Pencarian sebelumnya</h6>
                            </div>

                            <div class="dropdown-item bg-transparent text-wrap">
                                <a href="/master-obat" class="btn btn-soft-secondary btn-sm rounded-pill">master obat <i class="mdi mdi-magnify ms-1"></i></a>
                                <a href="/transaksi-index" class="btn btn-soft-secondary btn-sm rounded-pill">transaksi <i class="mdi mdi-magnify ms-1"></i></a>
                                <a href="/laporan-perpetual" class="btn btn-soft-secondary btn-sm rounded-pill mt-1">perpetual <i class="mdi mdi-magnify ms-1"></i></a>
                            </div>
                            <!-- item-->
                            <div class="dropdown-header mt-2">
                                <h6 class="text-overflow text-muted mb-1 text-uppercase">Halaman</h6>
                            </div>
                            ...
                            <!-- item-->
                            <a href="/master-obat" class="dropdown-item notify-item">
                                <i class="ri-lifebuoy-line align-middle fs-18 text-muted me-2"></i>
                                <span>Master Obat</span>
                            </a>

                            <!-- item-->
                            <a href="/laporan-perpetual" class="dropdown-item notify-item">
                                <i class="ri-user-settings-line align-middle fs-18 text-muted me-2"></i>
                                <span>Laporan Perpetual</span>
                            </a>

                            <!-- item -->
                            <a href="/stock-opname" class="dropdown-item notify-item">
                                <i class="ri-user-settings-line align-middle fs-18 text-muted me-2"></i>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item bg-danger-subtle text-danger" href="javascript:void();" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="bx bx-power-off font-size-16 align-middle me-1"></i> <span key="t-logout"><?php echo app('translator')->get('translation.logout'); ?></span></a>
...
<?php /**PATH /Users/toni/Apps/laravel/perpetual-report-system/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>